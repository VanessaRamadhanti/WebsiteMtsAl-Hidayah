						...
						<?php if (count(array_slice($arr_posts, 0, 1)) > 0) { ?>
								...
								<div class="thumbnail no-border">
									...
									<div class="caption">
										...
										<p>
											<a href="<?=site_url('read/'.$post->id.'/'.$post->post_slug)?>" class="btn btn-primary btn-sm" role="button">Selengkapnya <i class="fa fa-angle-double-right" aria-hidden="true"></i></a>
										</p>
									</div>
								</div>
							<?php } ?>
		...
		<div class="col-md-6 col-xs-12">
			<div class="thumbnail">
				...
				<div class="caption">
					...
					<button onclick="preview(<?=$row->id?>)" class="btn btn-primary btn-sm"><i class="fa fa-search"></i></button>
				</div>
			</div>
		</div>
		<?php } ?>
...
<?php $this->load->view('themes/simplex/sidebar')?>

				...
				<div class="form-group">
					...
					<div class="col-sm-8">
						<div class="input-group">
	          			<input readonly="true" type="text" class="form-control input-sm" id="birth_date" name="birth_date">
				...
				<div class="form-group">
	  			...
	  			<div class="form-group">
	    			<div class="col-sm-offset-4 col-sm-8">
	      			<button type="button" onclick="<?=$onclick?>; return false;" class="btn btn-primary"><?=$button?></button>
	    			</div>
	  			</div>
			</form>
		</div>

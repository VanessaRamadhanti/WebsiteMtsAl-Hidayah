...
<html lang="en">
	<head>
		...
		<?=link_tag('views/themes/simplex/css/bootstrap.css')?>
		<?=link_tag('views/themes/simplex/css/font-awesome.min.css')?>
		<?=link_tag('views/themes/simplex/css/sm-core-css.css')?>
		<?=link_tag('views/themes/simplex/css/jquery.smartmenus.bootstrap.css')?>
		...
		<?=link_tag('views/themes/simplex/css/style.css')?>
		...
		<nav class="navbar navbar-inverse navbar-fixed-top">
			<div class="container">
				...
				<div id="navbar" class="navbar-collapse collapse">
					...
					<form style="margin-top: 5px;" class="navbar-form navbar-right" action="<?=site_url('hasil-pencarian')?>" method="POST">
